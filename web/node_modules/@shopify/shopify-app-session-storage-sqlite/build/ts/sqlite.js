...
var defaultSQLiteSessionStorageOptions = {
    ...
    migratorOptions: {
        ...
        migrations: migrations_1.migrationList,
    },
};
var SQLiteSessionStorage = /** @class */ (function () {
    function SQLiteSessionStorage(filename, opts) {
        ...
        this.db = new sqlite_connection_1.SqliteConnection(filename, this.options.sessionTableName);
    ...
    SQLiteSessionStorage.prototype.initMigrator = function (migratorOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.internalInit];
                    case 1:
                        _a.sent();
                        if (migratorOptions === null) {
                            ...
                            this.migrator = new sqlite_migrator_1.SqliteSessionStorageMigrator(this.db, migratorOptions);
                            this.migrator.validateMigrationList(migrations_1.migrationList);
                            return [2 /*return*/, this.migrator.applyMigrations()];
                        }
                        return [2 /*return*/];
                }
            });
