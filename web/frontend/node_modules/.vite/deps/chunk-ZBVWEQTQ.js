...
var require_FeedbackModal = __commonJS({
  "node_modules/@shopify/app-bridge/actions/FeedbackModal/index.js"(exports) {
    ...
    exports.close = close;
    var FeedbackModal = function(_super) {
...
var require_LeaveConfirmation = __commonJS({
  "node_modules/@shopify/app-bridge/actions/LeaveConfirmation/index.js"(exports) {
    ...
    var LeaveConfirmation = function(_super) {
...
var require_ResourcePicker = __commonJS({
  "node_modules/@shopify/app-bridge/actions/ResourcePicker/index.js"(exports) {
    ...
    exports.update = update;
    var ResourcePicker = function(_super) {
...
var require_buttonGroupHelper = __commonJS({
  "node_modules/@shopify/app-bridge/actions/buttonGroupHelper.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_ContextualSaveBar = __commonJS({
  "node_modules/@shopify/app-bridge/actions/ContextualSaveBar/index.js"(exports) {
    ...
    exports.update = update;
    var ContextualSaveBar = function(_super) {
...
var require_ChannelMenu = __commonJS({
  "node_modules/@shopify/app-bridge/actions/Menu/ChannelMenu/index.js"(exports) {
    ...
    exports.update = update;
    var ChannelMenu = function(_super) {
...
var require_MarketingExternalActivityTopBar = __commonJS({
  "node_modules/@shopify/app-bridge/actions/MarketingExternalActivityTopBar/index.js"(exports) {
    ...
    exports.update = update;
    var MarketingExternalActivityTopBar = function(_super) {
...
var require_Picker = __commonJS({
  "node_modules/@shopify/app-bridge/actions/Picker/index.js"(exports) {
    ...
    var unstable_Picker = function(_super) {
  ...
  "node_modules/web-vitals/dist/web-vitals.umd.cjs"(exports, module) {
    !function(e, n) {
      ...
      var n, t, i, r, o, a = -1, c = function(e2) {
        ...
        return a >= 0 ? i2 = "back-forward-cache" : t2 && (i2 = document.prerendering || f() > 0 ? "prerender" : document.wasDiscarded ? "restore" : t2.type.replace(/_/g, "-")), { name: e2, value: void 0 === n2 ? -1 : n2, rating: "good", delta: 0, entries: [], id: "v3-".concat(Date.now(), "-").concat(Math.floor(8999999999999 * Math.random()) + 1e12), navigationType: i2 };
      }, d = function(e2, n2, t2) {
        try {
        ...
        n2 = n2 || {}, b(function() {
          var t2, i2 = [1800, 3e3], r2 = C(), o2 = s("FCP"), a2 = d("paint", function(e3) {
            e3.forEach(function(e4) {
              "first-contentful-paint" === e4.name && (a2.disconnect(), e4.startTime < r2.firstHiddenTime && (o2.value = Math.max(e4.startTime - f(), 0), o2.entries.push(e4), t2(true)));
            });
          });
          a2 && (t2 = l(e2, o2, i2, n2.reportAllChanges), c(function(r3) {
            o2 = s("FCP"), t2 = l(e2, o2, i2, n2.reportAllChanges), p(function() {
              o2.value = performance.now() - r3.timeStamp, t2(true);
            });
          }));
        });
      }, w = function(e2, n2) {
        n2 = n2 || {}, L(m(function() {
          var t2, i2 = [0.1, 0.25], r2 = s("CLS", 0), o2 = 0, a2 = [], u2 = function(e3) {
            e3.forEach(function(e4) {
              if (!e4.hadRecentInput) {
                var n3 = a2[0], t3 = a2[a2.length - 1];
                o2 && e4.startTime - t3.startTime < 1e3 && e4.startTime - n3.startTime < 5e3 ? (o2 += e4.value, a2.push(e4)) : (o2 = e4.value, a2 = [e4]);
              }
            }), o2 > r2.value && (r2.value = o2, r2.entries = a2, t2());
          }, f2 = d("layout-shift", u2);
          f2 && (t2 = l(e2, r2, i2, n2.reportAllChanges), v(function() {
            u2(f2.takeRecords()), t2(true);
          }), c(function() {
            o2 = 0, r2 = s("CLS", 0), t2 = l(e2, r2, i2, n2.reportAllChanges), p(function() {
              return t2();
            });
          }), setTimeout(t2, 0));
        }));
      }, S = { passive: true, capture: true }, P = new Date(), I = function(e2, r2) {
        n || (n = r2, t = e2, i = new Date(), M(removeEventListener), A());
      }, A = function() {
        if (t >= 0 && t < i - P) {
        ...
        if (e2.cancelable) {
          ...
          "pointerdown" == e2.type ? function(e3, n3) {
            var t2 = function() {
              ...
              removeEventListener("pointerup", t2, S), removeEventListener("pointercancel", i2, S);
            };
            addEventListener("pointerup", t2, S), addEventListener("pointercancel", i2, S);
          }(n2, e2) : I(n2, e2);
        }
      }, M = function(e2) {
        ...
        i2 = i2 || {}, b(function() {
          var o2, a2 = [100, 300], u2 = C(), f2 = s("FID"), p2 = function(e3) {
            e3.startTime < u2.firstHiddenTime && (f2.value = e3.processingStart - e3.startTime, f2.entries.push(e3), o2(true));
          }, h2 = function(e3) {
            e3.forEach(p2);
          }, g2 = d("first-input", h2);
          o2 = l(e2, f2, a2, i2.reportAllChanges), g2 && v(m(function() {
            h2(g2.takeRecords()), g2.disconnect();
          })), g2 && c(function() {
            var c2;
            f2 = s("FID"), o2 = l(e2, f2, a2, i2.reportAllChanges), r = [], t = -1, n = null, M(addEventListener), c2 = p2, r.push(c2), A();
          });
        });
      }, k = 0, x = 1 / 0, B = 0, R = function(e2) {
        e2.forEach(function(e3) {
          e3.interactionId && (x = Math.min(x, e3.interactionId), B = Math.max(B, e3.interactionId), k = B ? (B - x) / 7 + 1 : 0);
        });
      }, H = function() {
        return o ? k : performance.interactionCount || 0;
      }, N = function() {
        "interactionCount" in performance || o || (o = d("event", R, { type: "event", buffered: true, durationThreshold: 0 }));
      }, O = 0, j = function() {
        return H() - O;
      }, _ = [], q = {}, V = function(e2) {
        var n2 = _[_.length - 1], t2 = q[e2.interactionId];
        if (t2 || _.length < 10 || e2.duration > n2.latency) {
          if (t2)
            t2.entries.push(e2), t2.latency = Math.max(t2.latency, e2.duration);
          else {
            var i2 = { id: e2.interactionId, latency: e2.duration, entries: [e2] };
            q[i2.id] = i2, _.push(i2);
          }
          _.sort(function(e3, n3) {
            return n3.latency - e3.latency;
          }), _.splice(10).forEach(function(e3) {
            delete q[e3.id];
          });
        }
      }, z = function(e2, n2) {
        n2 = n2 || {}, b(function() {
          ...
          var i2, r2 = s("INP"), o2 = function(e3) {
            e3.forEach(function(e4) {
              (e4.interactionId && V(e4), "first-input" === e4.entryType) && (!_.some(function(n4) {
                return n4.entries.some(function(n5) {
                  return e4.duration === n5.duration && e4.startTime === n5.startTime;
                });
              }) && V(e4));
            });
            var n3, t3 = (n3 = Math.min(_.length - 1, Math.floor(j() / 50)), _[n3]);
            t3 && t3.latency !== r2.value && (r2.value = t3.latency, r2.entries = t3.entries, i2());
          }, a2 = d("event", o2, { durationThreshold: n2.durationThreshold || 40 });
          i2 = l(e2, r2, t2, n2.reportAllChanges), a2 && (a2.observe({ type: "first-input", buffered: true }), v(function() {
            o2(a2.takeRecords()), r2.value < 0 && j() > 0 && (r2.value = 0, r2.entries = []), i2(true);
          }), c(function() {
            _ = [], O = H(), r2 = s("INP"), i2 = l(e2, r2, t2, n2.reportAllChanges);
          }));
        });
      }, G = {}, J = function(e2, n2) {
        n2 = n2 || {}, b(function() {
          var t2, i2 = [2500, 4e3], r2 = C(), o2 = s("LCP"), a2 = function(e3) {
            var n3 = e3[e3.length - 1];
            if (n3) {
              var i3 = Math.max(n3.startTime - f(), 0);
              i3 < r2.firstHiddenTime && (o2.value = i3, o2.entries = [n3], t2());
            }
          }, u2 = d("largest-contentful-paint", a2);
          if (u2) {
            t2 = l(e2, o2, i2, n2.reportAllChanges);
            var h2 = m(function() {
              G[o2.id] || (a2(u2.takeRecords()), u2.disconnect(), G[o2.id] = true, t2(true));
            });
            ["keydown", "click"].forEach(function(e3) {
              addEventListener(e3, h2, true);
            }), v(h2), c(function(r3) {
              o2 = s("LCP"), t2 = l(e2, o2, i2, n2.reportAllChanges), p(function() {
                o2.value = performance.now() - r3.timeStamp, G[o2.id] = true, t2(true);
              });
            });
          }
        });
        ...
        n2 = n2 || {};
        var t2 = [800, 1800], i2 = s("TTFB"), r2 = l(e2, i2, t2, n2.reportAllChanges);
        K(function() {
          var o2 = u();
          if (o2) {
            var a2 = o2.responseStart;
            if (a2 <= 0 || a2 > performance.now())
              return;
            i2.value = Math.max(a2 - f(), 0), i2.entries = [o2], r2(true), c(function() {
              i2 = s("TTFB", 0), (r2 = l(e2, i2, t2, n2.reportAllChanges))(true);
            });
          }
        });
      };
      e.getCLS = w, e.getFCP = L, e.getFID = D, e.getINP = z, e.getLCP = J, e.getTTFB = Q, e.onCLS = w, e.onFCP = L, e.onFID = D, e.onINP = z, e.onLCP = J, e.onTTFB = Q, Object.defineProperty(e, "__esModule", { value: true });
    });
  }
});
...
var require_actions4 = __commonJS({
  "node_modules/@shopify/app-bridge/actions/index.js"(exports) {
    ...
    exports.Modal = Modal;
    var ModalContent = __importStar(require_ModalContent());
    exports.ModalContent = ModalContent;
    ...
    exports.ContextualSaveBar = ContextualSaveBar;
    var Share = __importStar(require_Share());
    exports.Share = Share;
    var NavigationMenu = __importStar(require_NavigationMenu());
    exports.NavigationMenu = NavigationMenu;
    var ChannelMenu = __importStar(require_ChannelMenu());
    exports.ChannelMenu = ChannelMenu;
    var AppLink = __importStar(require_AppLink());
    exports.AppLink = AppLink;
    var Pos = __importStar(require_Pos());
    exports.Pos = Pos;
    var MarketingExternalActivityTopBar = __importStar(require_MarketingExternalActivityTopBar());
    exports.MarketingExternalActivityTopBar = MarketingExternalActivityTopBar;
    var Performance = __importStar(require_Performance());
...
export {
  ...
  require_Picker,
  require_WebVitals,
  require_actions4 as require_actions
};
//# sourceMappingURL=chunk-ZBVWEQTQ.js.map
